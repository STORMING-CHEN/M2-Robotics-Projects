...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;The **/scan** topic is used to get the laser information reading form the robot. This topic uses **LaserScan** type message, and from its **ranges** parameter we can know the distance between the robot and nearby objects.
